...
@media (min-width:981px){
  ...
  #bc-global-nav .bluecard-nav .menu>li>a::after{content:"";position:absolute;left:14px;right:14px;bottom:0;height:3px;border-radius:999px;background:#0b4f9c;transform:scaleX(0);transform-origin:center;transition:transform 280ms cubic-bezier(.22,.61,.36,1);pointer-events:none}
...
<nav class="bluecard-nav" aria-label="Main Navigation">
  ...
  <div class="bluecard-nav-inner">
    ...
    <li class="menu-item-has-children"><a href="/bluecard/how-we-help/">How We Help</a><ul class="sub-menu"><li><a href="/bluecard/emergency-assistance/index.html">Emergency Assistance</a></li><li><a href="/bluecard/ongoing-support/index.html">Ongoing Support</a></li><li><a href="/bluecard/medication-assistance/index.html">Medication Assistance</a></li><li><a href="/bluecard/health-well-being/index.html">Health &amp; Well-Being</a></li></ul></li>
    ...
    <li class="menu-item-has-children"><a class="bluecard-nav-parent" href="#" aria-haspopup="true">Become Involved</a><ul class="sub-menu"><li><a href="/bluecard/donate/">Donate</a></li><li><a href="/bluecard/bnei-mitzvah-simcha-project">B’nei Mitzvah Simcha Project</a></li><li><a href="/bluecard/team-blue-card/">Team Blue Card</a></li><li><a href="/bluecard/volunteering/">Volunteering</a></li><li><a href="https://bluecardcoffee.org/" target="_blank" rel="noopener noreferrer">Blue Card Coffee</a></li></ul></li>
    ...
    <li class="menu-item-has-children"><a class="bluecard-nav-parent" href="#" aria-haspopup="true">More</a><ul class="sub-menu"><li><a href="/bluecard/board-members/">Board Members</a></li><li><a href="/bluecard/staff/">Staff Members</a></li><li><a href="/bluecard/contact/">Contact Us</a></li><li><a href="/bluecard/990-financials/">990 &amp; Financials</a></li><li><a href="/bluecard/archive/index.html">Archive</a></li></ul></li>
    </ul>
  </div>
</nav>`;

    var currentPath = (window.location.pathname || '/').replace(/\/+$/, '') || '/';
    var navLinks = navTarget.querySelectorAll('.menu a');
    navLinks.forEach(function (link) {
      if (link.getAttribute('href') === '#') return;
      var linkPath = new URL(link.href, window.location.origin).pathname.replace(/\/index\.html$/, '').replace(/\/+$/, '') || '/';
      if (linkPath === currentPath.replace(/\/index\.html$/, '')) {
