...
<nav class="bluecard-nav" aria-label="Main Navigation">
  ...
  <div class="bluecard-nav-inner">
    ...
    var updateSpeakersDropdown = function (speakers) {
      ...
      var list = navTarget.querySelector('.menu a[href="/bluecard/speakers-bureau/"]');
      if (!list) return;
      ...
      sub.innerHTML = speakers.map(function (speaker) {
        return '<li><a href="/bluecard/speakers-bureau/#' + speaker.slug + '">' + speaker.name + '</a></li>';
      }).join('');
    };
